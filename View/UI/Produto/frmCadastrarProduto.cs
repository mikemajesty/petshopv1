...
namespace View.Enum.UI.ViewProduto
{
            ...
            try
            {
                ...
                switch (_tipoOperacao)
                {
                    ...
                    case EnumTipoOperacao.ListView:
                        ...
                        PopulaTxt();
                        MudarCorDoBotao(Color.LightCoral);
                        MudarTextoDoForm("Retirar produto da Venda");
                        MudarTextoDoBotao("Retirar Produto");
                        DesabilitarCampos();
                        DesabilitarGroupBoxDeTipoDeCadastro();
                        DesabilitarGroupBoxDadosDoPeso(gpbDadosPeso);
            ...
            try
            {
                ...
                switch (_tipoOperacao)
                {
                    ...
                    case EnumTipoOperacao.Estoque:
                        ...
                        break;
                    case EnumTipoOperacao.ListView:
                        if (DialogMessage.MessageFullQuestion("Deseja Retirar esse item da Venda?", "Aviso") == DialogResult.Yes)
                        {
                            PosSalvamento();
                        }
                        break;
